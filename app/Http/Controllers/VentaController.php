...

{
    ...
    {
        $venta->load('detalle_ventas.incubadora', 'avicultor');

        $data = [
            'venta' => $venta,
            'empresa' => [
                'nombre' => env('APP_NAME', 'Mi Empresa'),
                'direccion' => 'Tu dirección',
                'telefono' => '000-000-000',
                'nit' => '000000000', // puedes cambiarlo por "N/A" si es solo recibo
            ],
            'fecha_emision' => Carbon::parse($venta->fecha_venta)->format('d/m/Y H:i'),
        ];
        ...
        return $pdf->download($filename); // o ->download($filename)
    }
}
