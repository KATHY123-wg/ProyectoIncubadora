...
public function setCorreoAttribute($value)
    {
        if ($value === null) { $this->attributes['correo'] = null; return; }
        $v = trim((string)$value);
...
protected $fillable = [
    'nombre','apellido1','apellido2','usuario','correo','contraseña',
    'ci_nit','telefono','direccion','rol','estado','modificado_por'
];
